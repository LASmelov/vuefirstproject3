<template>
    <section class="flex justify-start flex-col  mx-[5%] my-[50px]">
        ...
        <section class="flex  gap-10">
            <div><h1 class="text-[36px]">Flash Sales</h1></div>
        <div>
            <div class='wrapper'>
                ...
                <div class='time-part-wrapper'>
                  ...
                  <section >
                    ...
                    <div class="flex items-end justify-around mb-10 gap-[40px]">
                      <b-card v-for="(card, index) in cardsData" :key="index">
                        ...
                        <!-- Добавьте другие элементы карточки по вашему желанию -->
                      </b-card>
                    </div>
...
export default {
  props: {
    cardsData: Array, // Принимаем массив данных для карточек через props
  },
